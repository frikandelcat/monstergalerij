...
new #[Layout('components.layouts.auth')] class extends Component {
    ...
    public function login(): void
    {
        ...
        // $this->redirectIntended(default: route('monsters.index', absolute: false), navigate: true);
        $this->redirectIntended(default: route('monsters.index', absolute: false), navigate: false);
    }
